"""
Django settings for Durus Platform.
"""
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "durus"),
        "USER": os.environ.get("POSTGRES_USER", "durus"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "durus"),
